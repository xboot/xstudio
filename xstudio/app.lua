...
return {
  ...
  stringtable = {
    editor = "Xboot Studio",
    about = "About Xboot Studio",
    editormessage = "Xboot Studio Message",
    statuswelcome = "Welcome To Xboot Studio",
    settingsapp = "XbootStudio",
    settingsvendor = "xboot.org",
    logo = "res/xstudio-logo.png",
    help = "xbootstudio",
  },
}
